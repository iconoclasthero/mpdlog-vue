...
<template>
  <svg
    ...
    xml:space="preserve"
  >
    <title>{{ isScrobbling ? 'Disable Last.fm scrobbling' : 'Enable Last.fm scrobbling' }}</title>
    <g>
      <!-- 1. Background Square (Reactive to scrobbler state) -->
      <path
        :fill="isScrobbling ? '#b90000' : '#666666'"
        d="M89,0H5C2.238,0,0,2.239,0,5v84c0,2.761,2.238,5,5,5h84c2.762,0,5-2.239,5-5V5C94,2.239,91.762,0,89,0z"
      />

      <!-- 2. Inner Last.fm Shape (Solid White) -->
      <path
        :fill="isScrobbling ? '#ffffff' : '#ffffff'"
